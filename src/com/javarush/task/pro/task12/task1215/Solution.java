...
public class Solution {
    ...
    public static void removeGlassesReverse(ArrayList<String> glasses) {
        ...
        // ТУТ по фиклу, начиная с конца списка улаляем элементы
        // счетчик отнимаем т.к. список постоянно сокращается после удаления элемента
        for (int i = glasses.size()-1; i >=0;) {
            glasses.remove(i);
            i--;
        }
